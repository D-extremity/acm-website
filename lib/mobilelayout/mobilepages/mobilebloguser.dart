...
class MobileBlogUserPage extends StatefulWidget {
  final Map<String, dynamic> detail;
  const MobileBlogUserPage({super.key, required this.detail});

  @override
  State<MobileBlogUserPage> createState() => _MobileBlogUserPageState();
}

class _MobileBlogUserPageState extends State<MobileBlogUserPage> {
